...
<img src="images/diagram.png" style="width: 80%; margin: auto" border="rounded">
...
- in der Lehre will man eventuell nicht mit vorgefertigtem Code arbeiten, sondern eher Code entwickeln

---

# Speicherung des Jupyter-Notebooks im JSON-Format

```json {all|100}{maxHeight:'400px'}
{
 "cells": [
  {
   "cell_type": "markdown",
